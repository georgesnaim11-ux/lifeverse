    ...
    <div className="lv-app">
      ...
      {(game.phase === 'playing' || game.phase === 'events' || game.phase === 'outcome') && game.charState && game.fullData && (
        <MobileGameLayout
          ...
          onBusinessCreate={game.businessCreate}
          onBusinessLaunchProduct={game.businessLaunchProduct}
          onBusinessSetPrice={game.businessSetPrice}
          onBusinessSetProductMarketing={game.businessSetProductMarketing}
          onBusinessImprove={game.businessImprove}
          onBusinessDiscontinue={game.businessDiscontinue}
          onBusinessHire={game.businessHire}
          onBusinessFire={game.businessFire}
          onBusinessTrain={game.businessTrain}
          onBusinessBonus={game.businessBonus}
          onBusinessTeamBuilding={game.businessTeamBuilding}
          onBusinessSupplier={game.businessSupplier}
          onBusinessFindSupplier={game.businessFindSupplier}
          onBusinessConsultantHire={game.businessConsultantHire}
          onBusinessConsultantDrop={game.businessConsultantDrop}
          onBusinessExpand={game.businessExpand}
          onBusinessExpandLocations={game.businessExpandLocations}
          onBusinessInvest={game.businessInvest}
          onBusinessWithdraw={game.businessWithdraw}
          onBusinessSell={game.businessSell}
