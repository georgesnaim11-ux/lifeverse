...
const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'ballon_dor',        check: ({ flags }) => flags['ballonDor'] === true },
  { id: 'league_champion',   check: ({ flags }) => flags['sportsLeagueChampion'] === true },
  { id: 'club_captain',      check: ({ flags }) => flags['sportsCaptain'] === true },
  { id: 'founder',           check: ({ flags }) => flags['foundedBusiness'] === true },
  { id: 'business_millionaire', check: ({ flags }) => flags['businessMillionaire'] === true },
  { id: 'business_empire',   check: ({ flags }) => flags['businessEmpire'] === true },
